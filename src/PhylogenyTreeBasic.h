...
public:
    ...
    vector<int> &GetUserDataTbl() {return userDataTbl;}
    void SetUserDataTbl(const vector<int> &tbl) { userDataTbl = tbl; }
    void Dump() const;
...
private:
    ...
    std::vector<int> userDataTbl;   // for longer user data (useful for DP)
} ;
